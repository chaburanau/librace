//! Automobilista dashboard data provider.
...
pub const title = "Automobilista | librace";
...
pub fn fillData(ctx: *Context, data: *dashboard.Data) void {
    ...
    data.session_time = if (s.event_time_remaining >= 0) s.event_time_remaining / 1000.0 else 0;
    if (s.viewedParticipant()) |p| {
    ...
    data.var_count = ams.field_count;
...
fn formatTrack(ctx: *Context, s: *const ams.protocol.Shared) []const u8 {
...
fn formatTrackLength(ctx: *Context, s: *const ams.protocol.Shared) []const u8 {
