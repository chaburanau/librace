...
test "typed snapshot access and string fields" {
    ...
    @memcpy(gfx.car_model[0.."Ferrari 296 GT3".len], "Ferrari 296 GT3");
    @memcpy(stat.track[0.."Monza".len], "Monza");
    ...
    try std.testing.expectEqualStrings("Ferrari 296 GT3", client.graphics().carModel());
    try std.testing.expectEqualStrings("Monza", client.static().?.trackName());
}
